        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((p, index) => (
            <ScrollReveal key={p.title} delay={index * 120}>
              <article className="group flex flex-col overflow-hidden rounded-2xl border border-ink/10 bg-surface-muted/50 shadow-card-light transition hover:-translate-y-1 hover:border-accent/35 hover:shadow-glow dark:border-white/10 dark:bg-surface-muted/30 dark:shadow-card">
